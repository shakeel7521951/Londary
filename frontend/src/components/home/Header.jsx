    ...
    <div className="relative w-full h-[80vh] min-h-[560px] max-h-[600px] overflow-hidden">
      ...
      {showVideo && (
        <div className="absolute inset-0 z-20 bg-black">
          ...
          <button
            onClick={skipVideo}
            className="absolute top-4 right-4 bg-black/50 hover:bg-black/70 text-white px-4 py-2 rounded-full text-sm transition-colors duration-300 z-30"
          >
      ...
      {/* Slides - only show after video ends */}
      {videoEnded && (
        <>
          <div
